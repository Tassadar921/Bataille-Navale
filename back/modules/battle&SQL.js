...
const weapons = [
    ...
    {race : "Arash", data : [new Weapon("tirSup",999, 'Auto'),new Weapon("sonar",1, 'Sonar'),new Weapon("torpedo",2, 'Torpedo'),new Weapon("thermicShield",3, 'Thermic shield'),new Weapon("fireRing",3, 'Fire ring')]},
